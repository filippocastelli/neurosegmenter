...
RUN apt-get -y update
RUN apt-get -y install python3.8 python3.8-distutils python3.8-venv curl && update-alternatives --install /usr/bin/python python /usr/bin/python3.8 1  && curl https://bootstrap.pypa.io/get-pip.py -o get-pip.py && python get-pip.py
