...
class TiledPredictor2D:
    ...
    def generate_chunks(self):
        ...
        self.chunk_list_pivots  = self.list_chunks(self.batch_list_pivots, self.chunk_size)
...
if __name__ == "__main__":
    ...
    tpred = TiledPredictor2D(input_volume, window_size=window_size, batch_size=5, model=mockmodel)