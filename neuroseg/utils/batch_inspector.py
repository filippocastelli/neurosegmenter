...
class BatchInspector3D(BatchInspectorBase):
    def __init__(self, batch):
        ...
        super().__init__((self.frame3d, self.mask3d), keymap_conflicts=keymap_conflicts, block=False)
        self._create_btns3d()
        plt.show(block=True)
    ...
    def _update_titles(self):
        for ax in self.axs:
            ax.set_title("Sample {}/{}, Slice {}/{}".format(self.frame3d_idx, self.n_3d_frames, self.index, self.n_imgs))
